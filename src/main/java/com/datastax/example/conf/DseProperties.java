...
public class DseProperties {
	...
	private Conf solrConf = new Conf();
	...
	public Conf getSolrConf() {
		return solrConf;
	}

	public void setSolrConf(Conf solrConf) {
	...
	class Conf {
		...
		public void setConstantSpeculativeExecutionPolicyMaxNumber(
				Integer constantSpeculativeExecutionPolicyMaxNumber) {
